...
tf.app.flags.DEFINE_string(
    'train_tfrecord', '/media/ps/Windows/Data/maestro-v1.0.0/'
    'maestro-v1.0.0_ns_wav_train.tfrecord', 'Path to training tfrecord')
tf.app.flags.DEFINE_string(
    'test_tfrecord', '/media/ps/Windows/Data/maestro-v1.0.0/'
    'maestro-v1.0.0_ns_wav_test.tfrecord', 'Path to training tfrecord')
tf.app.flags.DEFINE_string(
    'validation_tfrecord', '/media/ps/Windows/Data/maestro-v1.0.0/'
    'maestro-v1.0.0_ns_wav_validation.tfrecord', 'Path to training tfrecord')
tf.app.flags.DEFINE_string('output_directory', '/media/ps/Windows/Data/google_maestro_tfrecord/', 'Path to output_directory')
